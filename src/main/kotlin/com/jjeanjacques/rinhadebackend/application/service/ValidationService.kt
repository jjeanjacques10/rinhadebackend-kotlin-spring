...
class ValidationService {
    fun validPerson(person: PersonDto) {
        when {
            ...
            isNumber(person.nickName) -> throw IllegalArgumentTypeException("nome deve ser uma string nao numerica")
        ...
        person.stack?.forEach {
            ...
            if (isNumber(it)) throw IllegalArgumentTypeException("stack deve ser uma string nao numerica")
        }
    }
