...
GATLING_BIN_DIR=$HOME/Documents/Projects/rinhadebackend-kotlin-spring/stress-test/gatling-3.9.5/bin

WORKSPACE=$HOME/Documents/Projects/rinhadebackend-kotlin-spring/stress-test
